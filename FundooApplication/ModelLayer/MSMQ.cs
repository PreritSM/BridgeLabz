...
namespace ModelLayer
{
    public class MSMQ
    {
        ...
        private string receiverName; public void SendMessage(string token, string EmailId, string name)
        {
        ...
        private void MessageQueue_ReceiveCompleted(object sender, ReceiveCompletedEventArgs e)
        {
            try
            {
                ...
                SmtpClient smtpClient = new SmtpClient("smtp.gmail.com")
                {
                    Port = 587,
                    EnableSsl = true,
                    Credentials = new NetworkCredential("prerit.mittal29@gmail.com", "mbrgijugjppohmvo"),
                };
                mailMessage.From = new MailAddress("prerit.mittal29@gmail.com");
